...
class Labelme2Yolo(object):
    def __init__(self, labelme_dir, save_dir, val_size):
    ...
    def save_yaml(self):
        ...
        with open(yaml_path, 'w+') as yaml_file:
            ...
            yaml_file.write('nc: ' + str(len(self.labels)) + '\n\n')
            yaml_file.write('names: ' + ujson.dumps(self.labels))
...
if __name__ == '__main__':
    ...
    Labelme2Yolo(args.labelme_dir, args.save_dir, args.val_size)
